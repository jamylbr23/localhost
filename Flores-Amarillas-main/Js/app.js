...
let botonRegreso = document.createElement('button');
botonRegreso.className = "Button";
botonRegreso.textContent = "Regresar";
...
Boton1.addEventListener('click', function() {
    ...
    h1.remove();
    document.querySelector(".Texto").appendChild(botonRegreso);
});
...
function CrearVarias() {
  ...
  // Ocultar el lienzo antes de dibujar las flores
  ...
  // Mostrar el lienzo después de dibujar las flores
